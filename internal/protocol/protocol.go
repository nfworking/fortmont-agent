...
type PluginInstall struct { CommandID string `json:"commandId"`; PluginID string `json:"pluginId"`; PluginSlug string `json:"pluginSlug"`; PluginVersion string `json:"pluginVersion"`; ProfileID string `json:"profileId"`; ConfigVersion string `json:"configVersion"`; Config map[string]any `json:"config"`; DataSchema map[string]any `json:"dataSchema,omitempty"` }
type PluginStatus struct { PluginID string `json:"pluginId"`; Status string `json:"status"`; Version string `json:"version,omitempty"`; Error string `json:"error,omitempty"` }
...
type PluginData struct { PluginID string `json:"pluginId"`; PluginSlug string `json:"pluginSlug"`; SchemaVersion int `json:"schemaVersion"`; Timestamp int64 `json:"timestamp"`; Measurements []PluginMeasurement `json:"measurements"` }
